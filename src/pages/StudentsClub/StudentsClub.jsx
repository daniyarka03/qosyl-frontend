              ...
              {isLoading ? (
                ...
                <>
                  <img
                    ...
                    src={import.meta.env.VITE_SERVER_URL_MEDIA + imageClub}
                    alt="Club Logo"
                  />
                  ...
                  <div className={styles.project__control}>
                    {userID === club.author_id ? (
                      <>
                        <Link
                          className={styles.project__control__item}
                          to={`/edit-students-club/${clubID}`}
                        >
